...
- `정답 보기`를 누르면 현재 줄을 즉시 제출한 것으로 처리합니다. 이미 맞힌 어절은 유지하고, 빈칸과 오답에는 정답을 자동으로 채워 보여주면서 빨간 밑줄과 `오답` 상태를 표시합니다. 공개된 정답은 실제 입력값이나 정답 기록을 덮어쓰지 않으며, 닫은 뒤 다시 직접 시도할 수 있습니다.
